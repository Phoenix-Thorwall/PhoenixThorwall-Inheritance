public class VehicleRunner
{
    public static void main(String[] args)
    {
        ...
        Bicycle myBike = new Bicycle("Maximum Omega Death Taker", 2, 100);
        ...
        Transformer myTran = new Transformer("BumbleBee", 4, true);
        System.out.println(myTran.getName());
        System.out.println(myTran.getWheels());
        myTran.getAllegiance();
        myTran.move(10);
        myTran.turn(45);
        myTran.brake(.76);
        myTran.transform();
